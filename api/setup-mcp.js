...
class McpInstaller {
  ...
  printSuccessMessage() {
    ...
    console.log('');
    console.log('3. Choose your MCP transport:');
    console.log('');
    console.log('   ┌─────────────┬──────────────────┬──────┬────────────┬─────────────────────┐');
    console.log('   │ Transport   │ File             │ Port │ Auth       │ Use Case            │');
    console.log('   ├─────────────┼──────────────────┼──────┼────────────┼─────────────────────┤');
    console.log('   │ stdio       │ mcp_server.js    │ N/A  │ API key    │ Claude Desktop      │');
    console.log('   │ HTTP        │ mcp_http_server  │ 3001 │ API key    │ Web apps, cloud AI  │');
    console.log('   │ SSE+OAuth   │ mcp_sse_server   │ 3002 │ JWT/Bearer │ Enterprise, HIPAA   │');
    console.log('   └─────────────┴──────────────────┴──────┴────────────┴─────────────────────┘');
    console.log('');
    console.log('   Start commands:');
    console.log('   • Stdio mode: npm run start:mcp');
    console.log('   • HTTP mode:  npm run start:http');
    console.log('   • SSE mode:   npm run start:sse');
